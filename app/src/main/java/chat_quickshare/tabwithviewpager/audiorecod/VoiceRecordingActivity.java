package chat_quickshare.tabwithviewpager.audiorecod;
...
import chat_quickshare.model.UploadVoice;
import chat_quickshare.tabwithviewpager.AppController;
import chat_quickshare.tabwithviewpager.ChatActivity;
...
//        setSupportActionBar(toolbar);
    ...
    private void startRecording() {
        ...
        File file = new File(root.getAbsolutePath() + "/QuckshareApp/Audios");
        if (!file.exists()) {
            file.mkdirs();
        }

        fileName =  root.getAbsolutePath() + "/QuckshareApp/Audios/" + String.valueOf(System.currentTimeMillis() + ".mp3");
    ...
    private void stopRecording() {
        ...
        startActivity(new Intent(VoiceRecordingActivity.this, ChatActivity.class));
        finish();
    }
    ...
    private void uploadVideo() {
        class UploadVideo extends AsyncTask<Void, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                uploading = ProgressDialog.show(VoiceRecordingActivity.this, "Uploading File", "Please wait...", false, false);
            }
